<?php
/**
 * Plugin Name: WooCommerce Product Archive Customiser Mod
 * Plugin URI: https://wordpress.org/plugins/woocommerce-product-archive-customiser/
 * Version: 1.0.5
 * Description: Allows you to customise WooCommerce product archives. Change the number of product columns and the
 * number of products displayed per page. Toggle the display of core elements and enable some that are not included in
 * WooCommerce core such as stock levels and product categories. Author: jameskoster Tested up to: 4.7.3 Author URI:
 * http://jameskoster.co.uk Text Domain: woocommerce-product-archive-customiser Domain Path: /languages/ License: GNU
 * General Public License v3.0 License URI: http://www.gnu.org/licenses/gpl-3.0.html
 *
...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ), true ) ) {
	...
	deactivate_plugins( 'woocommerce-product-archive-customiser/woocommerce-product-archive-customiser.php' );
	/**
	 * Localisation
	 */
	...
	if ( ! class_exists( 'WC_Custom_Archive' ) ) {
		...
		final class WC_Custom_Archive {
			...
			public function __construct() {
				...
				add_action( 'wp_enqueue_scripts', [ $this, 'wc_pac_styles' ] );
				add_action( 'init', [ $this, 'wc_pac_setup' ] );
				add_action( 'wp', [ $this, 'wc_pac_fire_customisations' ] );
				add_filter( 'body_class', [ $this, 'wc_pac_fire_customisation_styles' ] );
				add_action( 'wp', [ $this, 'wc_pac_columns' ] );
				add_filter( 'loop_shop_per_page', [ $this, 'woocommerce_pac_products_per_page' ], 20 );

				// Upgrade script.
				if ( version_compare( $this->version, '1.0.0' ) >= 0 ) {
					add_action( 'plugins_loaded', [ $this, 'update_settings' ] );
				}
			}
			...
			public function wc_pac_setup() {
				add_action( 'customize_register', [ $this, 'wc_pac_customize_register' ] );
			}
			...
			public function wc_pac_customize_register( $wp_customize ) {
				 ...
				 * Product Columns
				 */
				$wp_customize->add_setting( 'wc_pac_columns', [
					'default'           => '4',
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_choices' ],
				] );
				 ...
				 * Products Per Page
				 */
				$wp_customize->add_setting( 'wc_pac_products_per_page', [
					'default'           => '10',
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_choices' ],
				] );
				 ...
				 */
				$wp_customize->add_setting( 'wc_pac_product_count', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 */
				$wp_customize->add_setting( 'wc_pac_product_sorting', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 */
				$wp_customize->add_setting( 'wc_pac_sale_flash', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 */
				$wp_customize->add_setting( 'wc_pac_add_to_cart', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 */
				$wp_customize->add_setting( 'wc_pac_thumbnail', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 * Display - price
				 */
				$wp_customize->add_setting( 'wc_pac_price', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 * Display - ratings
				 */
				$wp_customize->add_setting( 'wc_pac_rating', [
					'default'           => true,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 * Display - new badge
				 */
				$wp_customize->add_setting( 'wc_pac_new_badge', [
					'default'           => false,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 * Products Per Page
				 */
				$wp_customize->add_setting( 'wc_pac_newness', [
					'default'           => '7',
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_choices' ],
				] );
				...
				$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wc_pac_newness', [
					...
					'active_callback' => [ $this, 'is_new_badge_enabled' ],
				] ) );

				/**
				 * Display - categories
				 */
				$wp_customize->add_setting( 'wc_pac_categories', [
					'default'           => false,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
				 ...
				 * Display - stock
				 */
				$wp_customize->add_setting( 'wc_pac_stock', [
					'default'           => false,
					'transport'         => 'refresh',
					'sanitize_callback' => [ $this, 'wc_pac_sanitize_checkbox' ],
				] );
			...
			function wc_pac_fire_customisations() {
				...
				if ( get_theme_mod( 'wc_pac_new_badge', false ) === true ) {
					add_action( 'woocommerce_before_shop_loop_item_title', [
						$this,
						'woocommerce_pac_show_product_loop_new_badge',
					], 30 );
				}
				...
				if ( get_theme_mod( 'wc_pac_stock', false ) === true ) {
					add_action( 'woocommerce_after_shop_loop_item', [
						$this,
						'woocommerce_pac_show_product_stock',
					], 30 );
				}
				...
				if ( get_theme_mod( 'wc_pac_categories', false ) === true ) {
					add_action( 'woocommerce_after_shop_loop_item', [
						$this,
						'woocommerce_pac_show_product_categories',
					], 30 );
				}
			...
			function wc_pac_columns() {
				...
				if ( is_shop() || is_product_taxonomy() || is_product_category() || is_product_tag() ) {
					add_filter( 'body_class', [ $this, 'woocommerce_pac_columns' ] );
					add_filter( 'loop_shop_columns', [ $this, 'woocommerce_pac_products_row' ] );
				}
			}
